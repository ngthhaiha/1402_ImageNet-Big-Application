...
def train(config, training_chunked_samples_dir, testing_chunked_samples_file, training_sample_indices=None):
    ...
    # copy config file
    cfg_src = config.get("cfg_file", "./cfgs/ml_memAE_sc_cfg.yaml")
    shutil.copyfile(cfg_src, os.path.join(paths["log_dir"], "ml_memAE_sc_cfg.yaml"))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--cfg_file", type=str, default="./cfgs/ml_memAE_sc_cfg.yaml")
